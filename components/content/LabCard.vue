...
<style scoped>
.active-tab {
  @apply after:content-[''] after:absolute after:w-full after:h-0.5 after:bg-lightaccent dark:after:bg-darkaccent after:bottom-[-9px] after:left-0 after:pointer-events-none;
}
</style>
